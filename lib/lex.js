lex = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c248 = function(ids, t) { return {type:"TypedIdList", ids:ids, dtype:t }},
        peg$c249 = function(name, t, t2) {return {type: "Function", name:name, params:t, returns: t2}},
        peg$c250 = function(name, t2) {return {type:"Function", name:name, params:null, returns: t2}},
        peg$c251 = function(name, t, t2, exp) {return {type: "Function", name:name, params:t, returns: t2, expressions:exp}},
        peg$c252 = function(name, t2, exp) {return {type: "Function", name:name, params:null, returns: t2, expressions:exp}},
        peg$c253 = function(t, t2, exp) {return {type: "Function", params:t, returns: t2, expressions:exp}},
        peg$c254 = function(t2, exp) {return {type: "Function", params:null, returns: t2, expressions:exp}},
        peg$c255 = "||",
        ...
        peg$c284 = function(op) {return {type:"Unary", operation: "-", operand:op}},
        peg$c285 = function(op) {return {type:"Unary", operation: "+", operand:op}},
        peg$c286 = "~",
        peg$c287 = { type: "literal", value: "~", description: "\"~\"" },
        peg$c288 = function(op) {return {type:"Unary", operation: "~", operand:op}},
        peg$c289 = function(arguments) { return {type:"()", exp: arguments}; },
        peg$c290 = function(expList) { return {type:"[]", exp: expList}; },
        peg$c291 = "{",
        peg$c292 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c293 = function(base, args) {
        ...
        peg$c294 = function(exp) {return exp; },
        peg$c295 = function(name) {return {type: "old", id:name}},
        peg$c296 = function(name) {return {type:"Function", name:name, types:types }},
        peg$c297 = function(expr) {return {type:"Is error", expression:expr }},
        peg$c298 = function(ex) {return {type:"Typeex", expression:ex }},
        peg$c299 = function(ty) {return {type:"Type", dtype:ty }},
        peg$c300 = function(ty) {return {type:"Error", dtype:ty}},
        peg$c301 = function(dl, exp) {
            return {type:"Let", deflist:dl, body:exp }},
        peg$c302 = ":=",
        peg$c303 = { type: "literal", value: ":=", description: "\":=\"" },
        peg$c304 = function(left, exp) {return {type:"Definition", left:left, right:exp}},
        peg$c305 = function(name, ty) {return {id:name, dtype:ty}},
        peg$c306 = function(exp, th, elif, el) {return {type:"If", then:th, elseif:elif, else:el }},
