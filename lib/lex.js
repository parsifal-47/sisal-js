lex = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c303 = function(left, exp) {return {type:"Definition", left:left, right:exp}},
        peg$c304 = function(name, ty) {return {id:name, dtype:ty}},
        peg$c305 = function(exp, th, elif, el) {return {type:"If", then:th, elseif:elif, else:el }},
        ...
        peg$c307 = function(r, dl, ret) {return {type: "For", range:r, body:(dl!==null?dl[3]:""), returns:ret}},
        peg$c308 = function(init, expr, body, postcond, ret) {return {type: "For", init:init, condition:(expr!==null?expr[3]:""), postcondition:(postcond!==null?postcond[3]:""), body:(body!==null?body[3]:""), returns:ret }},
        peg$c309 = function(expr, body, ret) {return {type: "For", init:null, condition:expr, body:(body!==null?body[3]:""), returns:ret }},
        peg$c310 = function(body, expr, ret) {return {type: "For", init:null, condition:expr, body:body, returns:ret }},
        peg$c311 = function(range, gen) { if (gen!==null) return {type:gen[0][1][0], left:range, right:gen[2] }; else return range;},
        peg$c312 = function(name, range) {return {type: "Range", name:name, range:range }},
        peg$c313 = function(exp, exp2, exp3) { return {type:"RangeTriplet", exp:exp, exp2:exp2!==null ? exp2[3] : "", exp3:exp3!==null?exp3[3]:"" }},
        peg$c314 = function(r, el, el2, rt) { return {type:"Return Expression", reduction:r, expressions:el, whenex: el2!==null?el2[3]:"", retexp:rt!==null?rt[3]:""}},
        peg$c315 = function(name, exp) {return {type:"Reduction", name:name, expressions: exp!==null?exp[3]:"" }},
