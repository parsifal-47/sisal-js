        ...
        execute : function () {
            ...
            do {
                ...
                for (i=0;i<this.nodes.length;i++) 
                    if ((!this.nodes[i].ready || this.nodes[i].ready()) && left.indexOf(i)!==-1) {
                        ...
                        for (j=0; j<this.edges.length;j++)
                            if ((this.edges[j].nodeFrom === i) && 
                                ...
                                if (nodeTo === -1)
                                    ...
                                    this.nodes[nodeTo].outPorts[this.edges[j].portTo] = 
                                        this.nodes[i].outPorts[this.edges[j].portFrom].value;
                            }
...
node.binary = function (op, inPorts, outPorts) {
        ...
        this.outPorts = outPorts;
        this.fields = ["op"];
        this.toText = function () {return op;}
        this.ready = function () {return (this.inPorts[0].value && this.inPorts[0].value);}
        this.execute = function () {this.outPorts[0].value = 0;}
    }
