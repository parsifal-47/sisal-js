...
module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c304 = function(r, dl, ret) {return {type: "For", range:r, body:(dl!==""?dl[3]:""), returns:ret}},
        peg$c305 = function(init, expr, body, ret) {return {type: "For", init:init, condition:(expr!==""?expr[3]:""), body:(body!==""?body[3]:""), returns:ret }},
        peg$c306 = function(expr, body, ret) {return {type: "For", init:null, condition:expr, body:(body!==""?body[3]:""), returns:ret }},
        peg$c307 = function(body, expr, ret) {return {type: "For", init:null, condition:expr, body:body, returns:ret }},
        peg$c308 = function(range, gen) { if (gen!=="") return {type:gen[0][1][0], left:range, right:gen[2] }; else return range;},
        peg$c309 = function(name, range) {return {type: "Range", name:name, range:range }},
        peg$c310 = function(exp, exp2, exp3) { return {type:"RangeTriplet", exp:exp, exp2:exp2 !== "" ? exp2[3] : "", exp3:exp3!==""?exp3[3]:"" }},
        peg$c311 = function(r, el, el2, rt) { return {type:"Return Expression", reduction:r, expressions:el, whenex: el2!==""?el2[3]:"", retexp:rt!==""?rt[3]:""}},
        peg$c312 = function(name, exp) {return {type:"Reduction", name:name, expressions: exp!==""?exp[3]:"" }},
