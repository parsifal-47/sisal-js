  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "OldToken": parse_OldToken,
        "LetToken": parse_LetToken,
        "OperationToken": parse_OperationToken,
        "GetToken": parse_GetToken,
        "IfToken": parse_IfToken,
        "IsToken": parse_IsToken,
        "EndToken": parse_EndToken,
        "ErrorToken": parse_ErrorToken,
        "InToken": parse_InToken,
        "NullToken": parse_NullToken,
        "ReturnsToken": parse_ReturnsToken,
        "SetToken": parse_SetToken,
        "SwitchToken": parse_SwitchToken,
        "ReplaceToken": parse_ReplaceToken,
        "TagToken": parse_TagToken,
        "TrueToken": parse_TrueToken,
        "WhileToken": parse_WhileToken,
        "WithToken": parse_WithToken,
        "TypeToken": parse_TypeToken,
        "ThenToken": parse_ThenToken,
        "RepeatToken": parse_RepeatToken,
        "InitialToken": parse_InitialToken,
        "AtToken": parse_AtToken,
        "CrossToken": parse_CrossToken,
        "DotToken": parse_DotToken,
        "OfToken": parse_OfToken,
        "WhenToken": parse_WhenToken,
        "ArrayToken": parse_ArrayToken,
        "StreamToken": parse_StreamToken,
        "Ll": parse_Ll,
        "Lm": parse_Lm,
        "Lo": parse_Lo,
        "Lt": parse_Lt,
        ...
        "SomeDefinition": parse_SomeDefinition,
        "TypeDefinition": parse_TypeDefinition,
        "TypeRenaming": parse_TypeRenaming,
        "UserDataType": parse_UserDataType,
        "TypeItself": parse_TypeItself,
        "TypeList": parse_TypeList,
        "IdWithType": parse_IdWithType,
        "FieldList": parse_FieldList,
        "IdentifierList": parse_IdentifierList,
        "FunctionDefinition": parse_FunctionDefinition,
        "FunctionImplementation": parse_FunctionImplementation,
        "FunctionItself": parse_FunctionItself,
        "LogicalOrStringOperator": parse_LogicalOrStringOperator,
        "LogicalAndString": parse_LogicalAndString,
        "CompareOperator": parse_CompareOperator,
        "Compare": parse_Compare,
        "Priority1Operator": parse_Priority1Operator,
        "Priority1Operation": parse_Priority1Operation,
        "Priority2Operator": parse_Priority2Operator,
        "Priority2Operation": parse_Priority2Operation,
        "ToPowerOperation": parse_ToPowerOperation,
        "UnaryOperation": parse_UnaryOperation,
        "PostfixOperation": parse_PostfixOperation,
        "FunctionArgumentList": parse_FunctionArgumentList,
        "ExpressionList": parse_ExpressionList,
        "Operand": parse_Operand,
        "LetExpression": parse_LetExpression,
        "DefinitionList": parse_DefinitionList,
        "Definition": parse_Definition,
        "LValue": parse_LValue,
        "NameAndMaybeType": parse_NameAndMaybeType,
        "IfExpression": parse_IfExpression,
        "LoopExpression": parse_LoopExpression,
        "RangeGen": parse_RangeGen,
        "ForIndexRange": parse_ForIndexRange,
        "ForIndexRangeTriplet": parse_ForIndexRangeTriplet,
        "ReturnExpression": parse_ReturnExpression,
        "ReductionWithInitial": parse_ReductionWithInitial,
        "ReductionName": parse_ReductionName
      };
                  ...
                  if (result0 === null) {
                    ...
                    if (result0 === null) {
                      ...
                      if (result0 === null) {
                        ...
                        if (result0 === null) {
                          if (input.substr(pos, 9) === "reduction") {
                            result0 = "reduction";
                            pos += 9;
                          } else {
                            result0 = null;
                            if (reportFailures === 0) {
                              matchFailed("\"reduction\"");
                            }
                          }
                          if (result0 === null) {
      ...
      function parse_OldToken() {
        var result0, result1;
        var pos0, pos1;
        
        pos0 = pos;
        if (input.substr(pos, 3) === "old") {
          result0 = "old";
          pos += 3;
        } else {
          result0 = null;
      ...
      function parse_OperationToken() {
        var result0, result1;
        var pos0, pos1;
        
        pos0 = pos;
        if (input.substr(pos, 9) === "operation") {
          result0 = "operation";
          pos += 9;
        } else {
          result0 = null;
          if (reportFailures === 0) {
            matchFailed("\"operation\"");
          }
        }
        if (result0 !== null) {
          pos1 = pos;
      ...
      function parse_InitialToken() {
        var result0, result1;
        var pos0, pos1;
        
        pos0 = pos;
        if (input.substr(pos, 7) === "initial") {
          result0 = "initial";
          pos += 7;
        } else {
          result0 = null;
      ...
      function parse_DotToken() {
        var result0, result1;
        var pos0, pos1;
        
        pos0 = pos;
        if (input.substr(pos, 3) === "dot") {
          result0 = "dot";
          pos += 3;
        } else {
          result0 = null;
      ...
      function parse_SomeDefinition() {
        var result0;
        
        result0 = parse_FunctionImplementation();
        if (result0 === null) {
          result0 = parse_FunctionDefinition();
          if (result0 === null) {
            result0 = parse_TypeDefinition();
          }
        }
        return result0;
      }
      
      function parse_TypeDefinition() {
        var result0;
        
        result0 = parse_TypeRenaming();
        if (result0 === null) {
          result0 = parse_UserDataType();
        }
        return result0;
      }
      
      function parse_TypeRenaming() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, t) {return {type:"TypeRenaming", name:name, dtype:t}})(pos0, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_UserDataType() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, t) {return {type:"UserType", name:name, dtype:t}})(pos0, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_TypeItself() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            ...
            if (result1 !== null) {
              ...
              if (result2 !== null) {
                result3 = parse___();
                if (result3 !== null) {
                  result4 = parse_LogicalAndString();
                  if (result4 !== null) {
                    result5 = parse___();
                    if (result5 !== null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, e) {return {type:"TypeExpression", expression:e}})(pos0, result0[4]);
          }
          if (result0 === null) {
            pos = pos0;
          }
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, t) {return {type:"ArrayOf", dtype:t}})(pos0, result0[4]);
            }
            if (result0 === null) {
              pos = pos0;
            }
      ...
      function parse_IdWithType() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, ids, t) { return {type:"TypedIdList", ids:ids, dtype:t }})(pos0, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_FunctionDefinition() {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  result5 = parse___();
                  if (result5 !== null) {
                    result6 = parse_TypeList();
                    if (result6 !== null) {
                      result7 = parse___();
                      if (result7 !== null) {
                        result8 = parse_ReturnsToken();
                        if (result8 !== null) {
                          result9 = parse___();
                          if (result9 !== null) {
                            result10 = parse_TypeList();
                            if (result10 !== null) {
                              result11 = parse___();
                              if (result11 !== null) {
                                if (input.charCodeAt(pos) === 93) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, t, t2) {return {type: "Function", name:name, params:t, returns: t2}})(pos0, result0[2], result0[6], result0[10]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
              ...
              if (result2 !== null) {
                ...
                if (result3 !== null) {
                  ...
                  if (result4 !== null) {
                    result5 = parse___();
                    if (result5 !== null) {
                      result6 = parse_ReturnsToken();
                      if (result6 !== null) {
                        result7 = parse___();
                        if (result7 !== null) {
                          result8 = parse_TypeList();
                          if (result8 !== null) {
                            result9 = parse___();
                            if (result9 !== null) {
                              if (input.charCodeAt(pos) === 93) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, name, t2) {return {type:"Function", name:name, params:null, returns: t2}})(pos0, result0[2], result0[8]);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function parse_FunctionImplementation() {
                            ...
                            if (result10 !== null) {
                              ...
                              if (result11 !== null) {
                                ...
                                if (result12 !== null) {
                                  result13 = parse___();
                                  if (result13 !== null) {
                                    result14 = parse_ExpressionList();
                                    if (result14 !== null) {
                                      result15 = parse___();
                                      if (result15 !== null) {
                                        result16 = parse_EndToken();
                                        if (result16 !== null) {
                                          result17 = parse___();
                                          if (result17 !== null) {
                                            result18 = parse_FunctionToken();
                                            if (result18 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, t, t2, exp) {return {type: "Function", name:name, params:t, returns: t2, expressions:exp}})(pos0, result0[2], result0[6], result0[10], result0[14]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
                          ...
                          if (result8 !== null) {
                            ...
                            if (result9 !== null) {
                              ...
                              if (result10 !== null) {
                                result11 = parse___();
                                if (result11 !== null) {
                                  result12 = parse_ExpressionList();
                                  if (result12 !== null) {
                                    result13 = parse___();
                                    if (result13 !== null) {
                                      result14 = parse_EndToken();
                                      if (result14 !== null) {
                                        result15 = parse___();
                                        if (result15 !== null) {
                                          result16 = parse_FunctionToken();
                                          if (result16 !== null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, name, t2, exp) {return {type: "Function", name:name, params:null, returns: t2, expressions:exp}})(pos0, result0[2], result0[8], result0[12]);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function parse_FunctionItself() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, t, t2, exp) {return {type: "Function", params:t, returns: t2, expressions:exp}})(pos0, result0[4], result0[8], result0[12]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
                          ...
                          if (result8 !== null) {
                            ...
                            if (result9 !== null) {
                              ...
                              if (result10 !== null) {
                                result11 = parse___();
                                if (result11 !== null) {
                                  result12 = parse_EndToken();
                                  if (result12 !== null) {
                                    result13 = parse___();
                                    if (result13 !== null) {
                                      result14 = parse_FunctionToken();
                                      if (result14 !== null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, t2, exp) {return {type: "Function", params:null, returns: t2, expressions:exp}})(pos0, result0[6], result0[10]);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function parse_LogicalOrStringOperator() {
        var result0, result1;
        var pos0, pos1;
      ...
      function parse_LogicalAndString() {
        var result0, result1, result2, result3, result4, result5;
        var pos0, pos1, pos2;
        ...
        if (result0 !== null) {
          ...
          result2 = parse___();
          if (result2 !== null) {
            result3 = parse_LogicalOrStringOperator();
            if (result3 !== null) {
              result4 = parse___();
              if (result4 !== null) {
      ...
      function parse_Compare() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_Priority1Operation();
        if (result0 !== null) {
          result1 = [];
          pos2 = pos;
          result2 = parse___();
          if (result2 !== null) {
            ...
            if (result3 !== null) {
              result4 = parse___();
              if (result4 !== null) {
                result5 = parse_Priority1Operation();
                if (result5 !== null) {
                  result2 = [result2, result3, result4, result5];
                } else {
                  result2 = null;
      ...
      function parse_Priority1Operator() {
        var result0;
      ...
      function parse_Priority1Operation() {
        var result0, result1, result2, result3, result4, result5;
        var pos0, pos1, pos2;
        
        pos0 = pos;
        pos1 = pos;
        result0 = parse_Priority2Operation();
        if (result0 !== null) {
          result1 = [];
          pos2 = pos;
          result2 = parse___();
          if (result2 !== null) {
            result3 = parse_Priority1Operator();
            if (result3 !== null) {
              result4 = parse___();
              if (result4 !== null) {
                result5 = parse_Priority2Operation();
                if (result5 !== null) {
                  result2 = [result2, result3, result4, result5];
                } else {
                  result2 = null;
      ...
      function parse_Priority2Operator() {
        var result0, result1;
        var pos0, pos1;
      ...
      function parse_Priority2Operation() {
        var result0, result1, result2, result3, result4, result5;
        var pos0, pos1, pos2;
        
        pos0 = pos;
        pos1 = pos;
        result0 = parse_ToPowerOperation();
        if (result0 !== null) {
          result1 = [];
          pos2 = pos;
          result2 = parse___();
          if (result2 !== null) {
            result3 = parse_Priority2Operator();
            if (result3 !== null) {
              result4 = parse___();
              if (result4 !== null) {
                result5 = parse_ToPowerOperation();
                if (result5 !== null) {
                  result2 = [result2, result3, result4, result5];
                } else {
                  result2 = null;
      ...
      function parse_ToPowerOperation() {
        var result0, result1, result2, result3, result4, result5;
        var pos0, pos1, pos2;
        
        pos0 = pos;
        pos1 = pos;
        result0 = parse_UnaryOperation();
        if (result0 !== null) {
          result1 = [];
          pos2 = pos;
          result2 = parse___();
      ...
      function parse_UnaryOperation() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, op) {return {type:"Unary", operation: "-", operand:op}})(pos0, result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              result0 = parse_PostfixOperation();
            }
          }
        }
        return result0;
      ...
      function parse_PostfixOperation() {
        ...
        if (result0 !== null) {
          ...
          if (result2 !== null) {
            ...
            if (result3 !== null) {
              result4 = parse___();
              if (result4 !== null) {
                result5 = parse_FunctionArgumentList();
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result1 = parse___();
            if (result1 !== null) {
              result2 = parse_LogicalAndString();
              if (result2 !== null) {
                result3 = parse___();
                if (result3 !== null) {
                  if (input.charCodeAt(pos) === 41) {
      ...
      function parse_FunctionArgumentList() {
        var result0, result1, result2, result3, result4, result5;
        var pos0, pos1, pos2;
        
        pos0 = pos;
        pos1 = pos;
        result0 = parse_LogicalAndString();
        if (result0 !== null) {
          result1 = [];
          pos2 = pos;
          result2 = parse___();
          if (result2 !== null) {
            ...
            if (result3 !== null) {
              result4 = parse___();
              if (result4 !== null) {
                result5 = parse_LogicalAndString();
                if (result5 !== null) {
                  result2 = [result2, result3, result4, result5];
                } else {
                  result2 = null;
      ...
      function parse_Operand() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, name) {return {type: "old", id:name}})(pos0, result0[2]);
          }
          if (result0 === null) {
            pos = pos0;
          }
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, name) {return {type:"Function", name:name, types:types }})(pos0, result0[2]);
            }
            if (result0 === null) {
              pos = pos0;
            }
            if (result0 === null) {
              ...
              if (result0 === null) {
                result0 = parse_LetExpression();
                if (result0 === null) {
                  result0 = parse_IfExpression();
                  if (result0 === null) {
                    result0 = parse_LoopExpression();
                    if (result0 === null) {
                      result0 = parse_FunctionItself();
                      if (result0 === null) {
                        pos0 = pos;
                        pos1 = pos;
                        result0 = parse_IsToken();
                        if (result0 !== null) {
                          result1 = parse___();
                          if (result1 !== null) {
                            result2 = parse_ErrorToken();
                            if (result2 !== null) {
                              result3 = parse___();
                              if (result3 !== null) {
                                if (input.charCodeAt(pos) === 40) {
                                ...
                                if (result4 !== null) {
                                  result5 = parse___();
                                  if (result5 !== null) {
                                    result6 = parse_LogicalAndString();
                                    if (result6 !== null) {
                                      result7 = parse___();
                                      if (result7 !== null) {
                                        if (input.charCodeAt(pos) === 41) {
                        ...
                        if (result0 !== null) {
                          result0 = (function(offset, expr) {return {type:"Is error", expression:expr }})(pos0, result0[6]);
                        }
                        if (result0 === null) {
                          pos = pos0;
                        }
                        if (result0 === null) {
                          ...
                          if (result0 !== null) {
                            result0 = (function(offset, ex) {return {type:"Typeex", expression:ex }})(pos0, result0[4]);
                          }
                          if (result0 === null) {
                            pos = pos0;
                          }
                          if (result0 === null) {
                            ...
                            if (result0 !== null) {
                              result0 = (function(offset, ty) {return {type:"Type", dtype:ty }})(pos0, result0[4]);
                            }
                            if (result0 === null) {
                              pos = pos0;
                            }
                            if (result0 === null) {
                              ...
                              if (result0 !== null) {
                                result0 = (function(offset, ty) {return {type:"Error", dtype:ty}})(pos0, result0[4]);
                              }
                              if (result0 === null) {
                                pos = pos0;
                              }
      ...
      function parse_LetExpression() {
        var result0, result1, result2, result3, result4, result5, result6, result7, result8, result9, result10;
        var pos0;
        
        pos0 = pos;
        result0 = parse_LetToken();
        if (result0 !== null) {
          result1 = parse___();
          if (result1 !== null) {
            result2 = parse_DefinitionList();
            if (result2 !== null) {
              result3 = parse___();
              if (result3 !== null) {
                result4 = parse_InToken();
                if (result4 !== null) {
                  result5 = parse___();
                  if (result5 !== null) {
                    ...
                    if (result6 !== null) {
                      result7 = parse___();
                      if (result7 !== null) {
                        result8 = parse_EndToken();
                        if (result8 !== null) {
                          result9 = parse___();
                          if (result9 !== null) {
                            result10 = parse_LetToken();
                            if (result10 !== null) {
                              result0 = [result0, result1, result2, result3, result4, result5, result6, result7, result8, result9, result10];
                            } else {
                              result0 = null;
      ...
      function parse_Definition() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, left, exp) {return {type:"Definition", left:left, right:exp}})(pos0, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_LValue() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_NameAndMaybeType();
        if (result0 !== null) {
          result1 = [];
          pos2 = pos;
          result2 = parse___();
          if (result2 !== null) {
            ...
            if (result3 !== null) {
              result4 = parse___();
              if (result4 !== null) {
                result5 = parse_NameAndMaybeType();
                if (result5 !== null) {
                  result2 = [result2, result3, result4, result5];
                } else {
                  result2 = null;
      ...
      function parse_NameAndMaybeType() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, ty) {return {id:name, dtype:ty}})(pos0, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_IfExpression() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, exp, th, el) {return {type:"If", then:th, else:el }})(pos0, result0[2], result0[6], result0[10]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_LoopExpression() {
        ...
        if (result0 !== null) {
          result1 = parse___();
          if (result1 !== null) {
            result2 = parse_RangeGen();
            if (result2 !== null) {
              pos2 = pos;
              result3 = parse___();
              if (result3 !== null) {
                result4 = parse_RepeatToken();
                if (result4 !== null) {
                  result5 = parse___();
                  if (result5 !== null) {
                    result6 = parse_DefinitionList();
                    if (result6 !== null) {
              ...
              if (result3 !== null) {
                result4 = parse___();
                if (result4 !== null) {
                  result5 = parse_ReturnsToken();
                  if (result5 !== null) {
                    result6 = parse___();
                    if (result6 !== null) {
                      result7 = parse_ReturnExpression();
                      if (result7 !== null) {
                        result8 = parse___();
                        if (result8 !== null) {
                          result9 = parse_EndToken();
                          if (result9 !== null) {
                            result10 = parse___();
                            if (result10 !== null) {
                              result11 = parse_ForToken();
                              if (result11 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, r, dl, ret) {return {type: "For", range:r, body:(dl!==""?dl[3]:""), returns:ret}})(pos0, result0[2], result0[3], result0[7]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result1 = parse___();
            if (result1 !== null) {
              result2 = parse_InitialToken();
              if (result2 !== null) {
                result3 = parse___();
                if (result3 !== null) {
                  result4 = parse_DefinitionList();
                  if (result4 !== null) {
                    pos2 = pos;
                    result5 = parse___();
                    if (result5 !== null) {
                      result6 = parse_WhileToken();
                      if (result6 !== null) {
                        result7 = parse___();
                        if (result7 !== null) {
                          result8 = parse_LogicalAndString();
                          if (result8 !== null) {
                    ...
                    if (result5 !== null) {
                      ...
                      result6 = parse___();
                      if (result6 !== null) {
                        result7 = parse_RepeatToken();
                        if (result7 !== null) {
                          result8 = parse___();
                          if (result8 !== null) {
                            result9 = parse_DefinitionList();
                            if (result9 !== null) {
                      ...
                      if (result6 !== null) {
                        ...
                        if (result7 !== null) {
                          ...
                          if (result8 !== null) {
                            result9 = parse___();
                            if (result9 !== null) {
                              result10 = parse_ReturnExpression();
                              if (result10 !== null) {
                                result11 = parse___();
                                if (result11 !== null) {
                                  result12 = parse_EndToken();
          ...
          if (result0 !== null) {
            result0 = (function(offset, init, expr, body, ret) {return {type: "For", init:init, condition:(expr!==""?expr[3]:""), body:(body!==""?body[3]:""), returns:ret }})(pos0, result0[4], result0[5], result0[6], result0[10]);
          }
          if (result0 === null) {
            pos = pos0;
          }
          if (result0 === null) {
                ...
                if (result2 !== null) {
                  ...
                  if (result3 !== null) {
                    ...
                    if (result4 !== null) {
                      ...
                      result5 = parse___();
                      if (result5 !== null) {
                        result6 = parse_RepeatToken();
                        if (result6 !== null) {
                          result7 = parse___();
                          if (result7 !== null) {
                            result8 = parse_DefinitionList();
                            if (result8 !== null) {
                              result5 = [result5, result6, result7, result8];
                            } else {
                              result5 = null;
                      ...
                      if (result5 !== null) {
                        result6 = parse___();
                        if (result6 !== null) {
                          result7 = parse_ReturnsToken();
                          if (result7 !== null) {
                            result8 = parse___();
                            if (result8 !== null) {
                              result9 = parse_ReturnExpression();
                              if (result9 !== null) {
                                result10 = parse___();
                                if (result10 !== null) {
                                  result11 = parse_EndToken();
                                  if (result11 !== null) {
                                    result12 = parse___();
                                    if (result12 !== null) {
                                      result13 = parse_ForToken();
                                      if (result13 !== null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, expr, body, ret) {return {type: "For", init:null, condition:expr, body:(body!==""?body[3]:""), returns:ret }})(pos0, result0[4], result0[5], result0[9]);
            }
            if (result0 === null) {
              pos = pos0;
            }
            if (result0 === null) {
                          ...
                          if (result6 !== null) {
                            ...
                            if (result7 !== null) {
                              ...
                              if (result8 !== null) {
                                result9 = parse___();
                                if (result9 !== null) {
                                  result10 = parse_ReturnsToken();
                                  if (result10 !== null) {
                                    result11 = parse___();
                                    if (result11 !== null) {
                                      result12 = parse_ReturnExpression();
                                      if (result12 !== null) {
                                        result13 = parse___();
                                        if (result13 !== null) {
                                          result14 = parse_EndToken();
              ...
              if (result0 !== null) {
                result0 = (function(offset, body, expr, ret) {return {type: "For", init:null, condition:expr, body:body, returns:ret }})(pos0, result0[4], result0[8], result0[12]);
              }
              if (result0 === null) {
                pos = pos0;
              }
      ...
      function parse_RangeGen() {
        var result0, result1, result2, result3;
        var pos0, pos1, pos2, pos3;
        
        pos0 = pos;
        pos1 = pos;
        result0 = parse_ForIndexRange();
        if (result0 !== null) {
          pos2 = pos;
          pos3 = pos;
          result1 = parse___();
          if (result1 !== null) {
            result2 = parse_CrossToken();
            if (result2 !== null) {
      ...
      function parse_ForIndexRange() {
        ...
        if (result0 !== null) {
          result1 = parse___();
          if (result1 !== null) {
            result2 = parse_InToken();
            if (result2 !== null) {
              result3 = parse___();
              if (result3 !== null) {
                result4 = parse_ForIndexRangeTriplet();
                if (result4 !== null) {
                  result0 = [result0, result1, result2, result3, result4];
                } else {
                  result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, range) {return {type: "Range", name:name, range:range }})(pos0, result0[0], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_ForIndexRangeTriplet() {
        var result0, result1, result2, result3, result4, result5;
        var pos0, pos1, pos2;
      ...
      function parse_ReturnExpression() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_ReductionWithInitial();
        if (result0 !== null) {
          result1 = parse___();
          if (result1 !== null) {
            result2 = parse_OfToken();
            if (result2 !== null) {
              result3 = parse___();
              if (result3 !== null) {
                result4 = parse_ExpressionList();
                if (result4 !== null) {
                  pos2 = pos;
                  result5 = parse___();
                  if (result5 !== null) {
                    result6 = parse_WhenToken();
                    if (result6 !== null) {
                      result7 = parse___();
                      if (result7 !== null) {
                        result8 = parse_ExpressionList();
                        if (result8 !== null) {
                          result5 = [result5, result6, result7, result8];
                        } else {
                          result5 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, r, el, el2, rt) { return {type:"Return Expression", reduction:r, expressions:el, whenex: el2!==""?el2[3]:"", retexp:rt!==""?rt[3]:""}})(pos0, result0[0], result0[4], result0[5], result0[6]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_ReductionWithInitial() {
        var result0, result1, result2, result3, result4, result5, result6;
        var pos0, pos1, pos2;
        
        pos0 = pos;
        pos1 = pos;
        result0 = parse_ReductionName();
        if (result0 !== null) {
          pos2 = pos;
          result1 = parse___();
          if (result1 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, name, exp) {return {type:"Reduction", name:name, expressions: exp!==""?exp[3]:"" }})(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
